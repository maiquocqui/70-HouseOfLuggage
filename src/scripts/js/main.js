$(document).ready(function() {
    ...
    if ($(window).width() < 1200) {
        $('.headertop .colright').insertAfter('.menuwrap');
        $('.headermenu .search').insertAfter('.headertop .sitelogo');
        $('.headermenu .hotline').insertAfter('.search');
        $('.headermenu .language').insertBefore('.search');
    }
